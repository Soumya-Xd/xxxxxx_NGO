...
document.addEventListener("DOMContentLoaded", function () {
  ...
  idCardBtn.addEventListener("mouseenter", function () {
      hiddenButtons.style.opacity = "1";
      hiddenButtons.style.visibility = "visible";
  });

  idCardBtn.addEventListener("mouseleave", function () {
      setTimeout(() => {
  ...
  hiddenButtons.addEventListener("mouseenter", function () {
      hiddenButtons.style.opacity = "1";
      hiddenButtons.style.visibility = "visible";
  });

  hiddenButtons.addEventListener("mouseleave", function () {
      hiddenButtons.style.opacity = "0";
      hiddenButtons.style.visibility = "hidden";
  });
});
